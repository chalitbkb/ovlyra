  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "# ====================================================================\n",
        "# 🎯 CONFIG สำหรับ 59GB Disk — Optimized สำหรับเสียงไทยธรรมชาติ\n",
        "# ====================================================================\n",
        "# 🔧 Round 3 Optimized Config for Thai TTS Training on Dual T4\n",
        "# ====================================================================\n",
        "# Changes from Round 2 (based on training analysis):\n",
        "#   - LR: 5e-5 → 3e-5 (ลด 40%, modules_to_save 794M params overfit ที่ LR สูง)\n",
        "#   - warmup: 0.05 → 0.1 (ลด eval spike ช่วง warmup)\n",
        "#   - weight_decay: 0.01 → 0.03 (เพิ่ม regularization)\n",
        "#   - lora_dropout: 0.05 → 0.1 (ลด overfitting, train/eval gap ~4x)\n",
        "#   - epochs: 3 → 5 (eval loss ยังลดอยู่ ควรเทรนต่อ)\n",
        "#   - eval_steps: 300 → 200 (ติดตามละเอียดขึ้น)\n",
        "#   - save_steps: 500 → 400 (จับ best checkpoint แม่นขึ้น)\n",
        "# ====================================================================\n",
        "\n",
        "config = {\n",
        "    \"training\": {\n",
