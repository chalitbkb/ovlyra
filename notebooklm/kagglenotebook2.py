  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "# ====================================================================\n",
        "# 🔧 Round 4 Fast & Smart Config (Smarter model / Lower Total Steps)\n",
        "# ====================================================================\n",
        "# 🎯 เป้าหมาย: ลด Loss Spike ให้โมเดลฉลาดขึ้น + เทรนจบไวขึ้น 40%\n",
        "#   - gradient_accum: 16 (Global Batch 32) เสถียรขึ้นมาก\n",
        "#   - LR: 3e-5 → 1.5e-5 (ลด 50% ป้องกัน Catastrophic Forgetting)\n",
        "#   - warmup: 0.1 → 0.2 (อุ่นเครื่องนานขึ้น ลดอาการช็อคของ Embeddings)\n",
        "#   - clip_value: 1.0 → 0.5 (ตัด Gradient ตอนทะลุกรอบ)\n",
        "#   - dataset_weight: 5.0 → 3.0 (ลด Total Steps เหลือ ~831 เสร็จไวขึ้น!)\n",
        "#   - eval_steps: 100, save_steps: 200 (ลด I/O Overhead)\n",
        "# ====================================================================\n",
        "\n",
        "config = {\n",
        "    \"training\": {\n",
