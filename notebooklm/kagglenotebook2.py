  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "# ====================================================================\n",
        "# 🔧 Round 5 Anti-Overfit Config — ลด Overfit + หาจุด Sweet Spot\n",
        "# ====================================================================\n",
        "# 🎯 ปัญหา: 816M trainable params vs 8,874 samples = Overfit 920x\n",
        "#   → eval loss ไม่เคยต่ำกว่าสุ่ม → โมเดลสร้างเสียงเงียบ\n",
        "# แก้ไข:\n",
        "#   - dataset_weight: 3.0 → 1.0 (1 epoch, ~277 steps แทน 831)\n",
        "#   - LoRA r: 32 → 8 (ลด LoRA params 4 เท่า)\n",
        "#   - weight_decay: 0.03 → 0.1 (regularization แรงขึ้น)\n",
        "#   - save_steps: 50, keep: 5 (เก็บทุก 50 steps หา sweet spot)\n",
        "#   - eval_steps: 50 (ติดตาม eval loss ละเอียด)\n",
        "# ====================================================================\n",
        "\n",
        "config = {\n",
        "    \"training\": {\n",
