...
_DEFAULT_PHRASES = [
    ...
    "วันนี้อากาศดีมากเลย ไปเที่ยวกันไหม",
    "ราคาทั้งหมดอยู่ที่ 1,456 บาท",
    "ขอโทษนะครับ ผมไม่แน่ใจเลย ต้องลองถามคนอื่นดูก่อน",
    (
        "กรุงเทพมหานครเป็นเมืองหลวงของประเทศไทย มีประชากรมากกว่า 10 ล้านคน "
        "และเป็นศูนย์กลางเศรษฐกิจที่สำคัญที่สุดของภูมิภาคเอเชียตะวันออกเฉียงใต้"
    ),
    "ใครขายไข่ไก่ ไก่ของใคร ขายไข่ได้ ใครได้ขายไข่ไก่ ใครมีไก่ ไก่ของใครดี",
    "เมื่อวานนี้ฝนตกหนักมากเลย ถนนน้ำท่วมไปหมด รถติดยาวเป็นกิโลเลย",
    (
        "สมัยก่อนยังไม่มีโทรศัพท์มือถือ ต้องใช้โทรศัพท์บ้าน "
        "ถ้าอยากคุยกับเพื่อนต้องโทรไปที่บ้านของเขา"
    ),
    "ช่วยโทรไปที่เบอร์ 02 999 8888 ให้หน่อยได้ไหมครับ",
    "อาหารร้านนี้อร่อยมากเลย ต้องมาอีกแน่นอน",
]
